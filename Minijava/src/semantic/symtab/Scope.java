...
public class Scope {
	...
	public InfoVar insertVariable(InfoVar v) {
	...
	public InfoMethod insertMethod(InfoMethod m) {
	...
	public InfoKlass insertKlass(InfoKlass kl) {
	...
	private void print(IndentWriter out) {
		...
		for (Info i: this.getKlasses()) {
			out.println(i);
		}
		
		for (Info i: this.getMethods()) {
			out.println(i);
		}
		
		for (Info i: this.getVariables()) {
			out.println(i);
		}
